    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                При необходимости вы можете выйти из всех других сеансов вашего браузера на всех ваших устройствах. Ниже перечислены некоторые из ваших недавних сеансов; однако этот список может быть неполным. Если вы чувствуете, что ваша учетная запись была взломана, вам также следует обновить свой пароль.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Пожалуйста, введите свой пароль, чтобы подтвердить, что вы хотите выйти из других сеансов браузера на всех ваших устройствах.
